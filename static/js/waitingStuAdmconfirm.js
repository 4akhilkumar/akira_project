...
function isStuAdmRegConfirmed() {
    var enusername = document.querySelector(".wac-container").getAttribute("data-enusername");
    var isStuAdm_confirmed_url = document.querySelector(".wac-container").getAttribute("data-isStuAdm-confirmed-url");
...
setInterval(isStuAdmRegConfirmed, 10000);