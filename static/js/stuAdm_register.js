...
function setMinMaxDateOfBirth() {
    ...
    var fortyYrsAgo = today.getFullYear() - 40;
    ...
    fortyYrsAgo = fortyYrsAgo + '-' + mm + '-' + dd;
    eighteenYrsAgo = eighteenYrsAgo + '-' + mm + '-' + dd;
    document.getElementById("id_date_of_birth").setAttribute("min", fortyYrsAgo);
...
$(document).ready(function() {
    ...
    var firstname = false; var lastname = false; var dateofbirth = false;
    ...
    $('input, select').on('keyup keydown blur change', function() {
        if (firstname == true && lastname == true && dateofbirth == true && gender == true && phone == true && doorno == true && zipcode == true && city == true && district == true && state == true && country == true && photo == true) {
    ...
    $('#id_programme').on('keyup keydown blur change', function() {
        if ($("#id_programme").val() == "") {
            $("#id_programme").parent().find(".error-text").css("display", "block");
            programme = false;
        } else {
            $("#id_programme").parent().find(".error-text").css("display", "none");
            programme = true;
        }
    });
