...
$('#searchQueryInput').on('keyup keydown blur change', function() {
    if($("#searchQueryInput").val() == "") {
        $("#searchQueryInput").parent().find(".error-text").html("Enter your first name");
        $("#searchQueryInput").parent().find(".error-text").css("display", "block");
        searchQuery = false;
    }
    else if ($("#searchQueryInput").val().match(/^\s+$/)) {
        $("#searchQueryInput").parent().find(".error-text").html("Sorry, but your first name cannot be empty");
        $("#searchQueryInput").parent().find(".error-text").css("display", "block");
        searchQuery = false;
    }
    else {
